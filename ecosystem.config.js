  ...
  apps: [
    {
      ...
      script: "./dist/src/server.js", // Caminho para o arquivo JS compilado (pós-build)
      ...
      env: {
        ...
        PORT: 3001, // Porta da sua aplicação, pode ser sobrescrita por variáveis de ambiente do sistema
      },
      env_production: {
        NODE_ENV: "production",
